...
const buildTable = () => {
  const sciFiData = [
    ...
    {
      title: 'Russian Doll',
      image: 'https://m.media-amazon.com/images/M/MV5BMzRjYzA2YzgtYmEyYy00YzZjLTkzMGEtMWQ1M2Y2MTA2ZjcwXkEyXkFqcGdeQXVyMzQ2MDI5NjU@._V1_.jpg',
  ...
  sciFiData.forEach(show => {
    ...
    `      <div class="px-2">\n` +
    `        <h6>${show.title}</h6>\n` +
    `        <p class="small m-0">${show.description}</p>\n` +
    `      </div>\n` +
    `    </div>\n` +
    `  </td>\n` +
    `</tr>`;
